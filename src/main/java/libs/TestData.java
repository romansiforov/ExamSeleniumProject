...
public class TestData {
    ...
    public final static String VALID_SUCCESS_SUBSCRIPTION_TEXT = "Newsletter : You have successfully subscribed to this newsletter.";
    public final static String VALID_FAILURE_SUBSCRIPTION_TEXT = "Newsletter : Invalid email address.";
}
